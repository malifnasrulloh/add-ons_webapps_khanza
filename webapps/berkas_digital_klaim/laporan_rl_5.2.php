<?php
/*
 * File: laporan_rl_5.2.php
 * Fungsi: Laporan RL 5.2 10 Besar Kasus Baru Penyakit Rawat Jalan
 */
...
<head>
    ...
    <title>Laporan RL 5.2 - 10 Besar Kasus Baru Ralan</title>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body">
                    <h5 class="fw-bold text-primary mb-3 d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-chart-pie me-2"></i>Laporan RL 5.2 (10 Besar Kasus Baru Penyakit Rawat Jalan)</span>
                        ...
                        <table class="table table-bordered table-striped table-sm w-100" id="dataTable">
                            <thead>
                                <tr class="bg-dark text-white text-center">
                                    ...
                                    <th colspan="3" class="bg-primary text-white">Jumlah Kasus Baru</th>
                                </tr>
                                <tr>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-book-open me-2"></i>Petunjuk Teknis Pengisian RL 5.2</h5>
            ...
            <div class="modal-body" style="font-size: 0.85rem; line-height: 1.5;">
                <div class="alert alert-primary">
                    ...
                    <p>Data 10 Besar Kasus Baru Penyakit Rawat Jalan merupakan hasil dari Kompilasi Penyakit/Morbiditas Pasien Rawat Jalan (RL 5.1), yang dikelompokkan berdasarkan Kelompok ICD-10 kemudian diurutkan dari yang terbesar ke kecil berdasarkan angka di kolom Total Kasus Baru. Kode ICD-10 yang tidak masuk dalam 10 Besar yaitu O80, O82, R, V, W, X, Y, dan Z.</p>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-code me-2"></i>Logika Teknis SIMKES Khanza</h6>
                    <p>Sistem menarik data diagnosa primer (prioritas 1) dari tabel <code>diagnosa_pasien</code> yang difilter hanya untuk pasien Rawat Jalan. Penentuan "Kasus Baru" dilakukan dengan mengecek apakah pasien tersebut pernah mendapatkan diagnosa yang sama pada kunjungan-kunjungan sebelumnya di database.</p>
                    <hr>
    ...
    $(document).ready(function() {
        myTable = $('#dataTable').DataTable({
            columns: [
                ...
                { data: "diagnosis" },
                { data: "baru_l", className: "text-end" },
                { data: "baru_p", className: "text-end" },
                { data: "baru_total", className: "text-end fw-bold" }
            ],
