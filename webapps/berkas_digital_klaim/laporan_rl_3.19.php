<?php
/*
 * File: laporan_rl_3.19.php
 * Fungsi: Laporan RL 3.19 Rekapitulasi Cara Bayar
 */
...
<head>
    ...
    <title>Laporan RL 3.19 - Cara Bayar</title>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body">
                    <h5 class="fw-bold text-primary mb-3 d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-wallet me-2"></i>Laporan RL 3.19 (Rekapitulasi Cara Bayar)</span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-sm w-100" id="dataTable">
                            <thead>
                                <tr>
                                    <th rowspan="2">No</th>
                                    <th rowspan="2" class="text-start">Cara Pembayaran</th>
                                    <th colspan="2" class="bg-primary text-white">Pasien Rawat Inap</th>
                                    <th colspan="3" class="bg-success text-white">Jumlah Pasien Rawat Jalan</th>
                                </tr>
                                <tr>
                                    <th class="bg-primary-subtle">Pasien Keluar</th>
                                    <th class="bg-primary-subtle">Lama Dirawat</th>
                                    <th class="bg-success-subtle">Laboratorium</th>
                                    <th class="bg-success-subtle">Radiologi</th>
                                    <th class="bg-success-subtle text-dark">Lain-lain</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-book-open me-2"></i>Petunjuk Teknis Pengisian RL 3.19</h5>
            ...
            <div class="modal-body" style="font-size: 0.85rem; line-height: 1.5;">
                <div class="alert alert-primary">
                    ...
                    <p>Melaporkan rekapitulasi jumlah pasien keluar (hidup/mati) dan lama dirawat di rawat inap, serta jumlah pemeriksaan di unit rawat jalan (Lab, Radiologi, dll) berdasarkan cara pembayarannya.</p>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-code me-2"></i>Logika Teknis SIMKES Khanza</h6>
                    <p>Menghitung jumlah pasien keluar dari rawat inap (kamar_inap) dan kunjungan rawat jalan (reg_periksa) yang dikelompokkan berdasarkan jenis bayar (penjab). Lama dirawat dihitung dari selisih tanggal masuk dan keluar pada kamar inap.</p>
                    <hr>
                    <strong>Sumber Data:</strong>
                    <ul class="mb-0">
                        <li>reg_periksa (Registrasi Pasien)</li>
                        <li>kamar_inap (Data Rawat Inap & Pasien Keluar)</li>
                        <li>penjab (Master Cara Bayar)</li>
                    </ul>
                </div>
            </div>
    ...
    $(document).ready(function() {
        myTable = $('#dataTable').DataTable({
            columns: [
                ...
                { data: "cara_bayar" },
                { data: "ranap_keluar", className: "text-end" },
                { data: "ranap_lama", className: "text-end" },
                { data: "ralan_lab", className: "text-end" },
                { data: "ralan_rad", className: "text-end" },
                { data: "ralan_lain", className: "text-end" }
            ],
