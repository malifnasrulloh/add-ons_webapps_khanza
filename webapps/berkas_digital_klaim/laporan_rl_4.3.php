<?php
/*
 * File: laporan_rl_4.3.php
 * Fungsi: Laporan RL 4.3 10 Besar Kematian Penyakit Rawat Inap
 */
...
<head>
    ...
    <title>Laporan RL 4.3 - 10 Besar Kematian Ranap</title>
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4 py-4">
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body">
                    <h5 class="fw-bold text-danger mb-3 d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-skull me-2"></i>Laporan RL 4.3 - 10 Besar Kematian Penyakit Rawat Inap</span>
                        ...
                        <table class="table table-bordered table-striped table-sm w-100" id="dataTable">
                            <thead>
                                <tr class="bg-dark text-white text-center">
                                    ...
                                    <th colspan="3" class="bg-primary text-white">Pasien Hidup & Mati</th>
                                    <th colspan="3" class="bg-danger text-white">Pasien Mati</th>
                                </tr>
                                <tr>
                                    <th class="bg-primary-subtle">L</th>
                                    <th class="bg-primary-subtle">P</th>
                                    <th class="bg-primary text-white">Total</th>
                                    <th class="bg-danger-subtle">L</th>
                                    <th class="bg-danger-subtle">P</th>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-book-open me-2"></i>Petunjuk Teknis Pengisian RL 4.3</h5>
            ...
            <div class="modal-body" style="font-size: 0.85rem; line-height: 1.5;">
                <div class="alert alert-primary">
                    ...
                    <p>Menampilkan 10 besar penyebab kematian pasien rawat inap yang diurutkan berdasarkan jumlah total pasien keluar mati. Kode ICD-10 tertentu (O80, O82, R, V, W, X, Y, Z) biasanya dikecualikan.</p>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-code me-2"></i>Logika Teknis SIMKES Khanza</h6>
                    <p>Mengambil data dari rekapitulasi morbiditas rawat inap (RL 4.1), mengelompokkan berdasarkan 3 digit pertama kode ICD-10, dan mengurutkan 10 diagnosis dengan jumlah kematian tertinggi.</p>
                    <hr>
                    <strong>Sumber Data:</strong>
                    <ul class="mb-0">
                        <li><code>diagnosa_pasien</code> (Diagnosa Primer/Utama)</li>
                        <li><code>kamar_inap</code> (Data Pasien Keluar Mati)</li>
                        <li><code>penyakit</code> (Master ICD-10)</li>
    ...
    $(document).ready(function() {
        myTable = $('#dataTable').DataTable({
            columns: [
                ...
                { data: "diagnosis" },
                { data: "hidup_mati_l", className: "text-end" },
                { data: "hidup_mati_p", className: "text-end" },
                { data: "hidup_mati_total", className: "text-end fw-bold" },
                { data: "mati_l", className: "text-end text-danger" },
                { data: "mati_p", className: "text-end text-danger" },
                { data: "mati_total", className: "text-end fw-bold text-danger" }
            ],
