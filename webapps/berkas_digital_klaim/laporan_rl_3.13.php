<?php
/*
 * File: laporan_rl_3.13.php
 * Fungsi: Laporan RL 3.13 Rekapitulasi Kegiatan Pelayanan Rehabilitasi Medik
 */
...
<head>
    ...
    <title>Laporan RL 3.13 - Rehabilitasi Medik</title>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body">
                    <h5 class="fw-bold text-primary mb-3 d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-wheelchair me-2"></i>Laporan RL 3.13 - Rekapitulasi Kegiatan Pelayanan Rehabilitasi Medik</span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-sm w-100" id="dataTable">
                            <thead class="bg-dark text-white text-center">
                                <tr>
                                    <th width="5%">No</th>
                                    <th class="text-start">Jenis Tindakan</th>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-book-open me-2"></i>Petunjuk Teknis Pengisian RL 3.13</h5>
            ...
            <div class="modal-body" style="font-size: 0.85rem; line-height: 1.5;">
                <div class="alert alert-primary">
                    ...
                    <p>Melaporkan jumlah tindakan yang diberikan kepada pasien Rehabilitasi Medik meliputi tindakan medis, fisioterapi, okupasiterapi, terapi wicara, psikologi, sosial medis, dan ortotik prostetik.</p>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-code me-2"></i>Logika Teknis SIMKES Khanza</h6>
                    <p>Menghitung jumlah tindakan yang tercatat pada rawat jalan dokter maupun perawat yang difilter berdasarkan kategori tindakan Fisioterapi, Okupasi, Wicara, dll.</p>
                    <hr>
