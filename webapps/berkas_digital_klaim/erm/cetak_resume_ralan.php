<?php
/*
 * File: erm/cetak_resume_ralan.php
 * Fungsi: Preview Resume Medis Rawat Jalan (Layout Khanza Style)
 */
session_start();
...
if(!$data) die("<div style='text-align:center; margin-top:50px;'><h3>Data Resume Tidak Ditemukan</h3><p>Pastikan dokter sudah input resume rawat jalan.</p></div>");
...
// Untuk Ralan, Tgl Keluar biasanya sama dengan Tgl Registrasi (One Day Care)
...
<head>
    <meta charset="UTF-8">
    <title>Preview Resume Ralan - <?= $data['nm_pasien'] ?></title>
    <style>
        ...
        .page { 
            background: white; width: 210mm; min-height: 297mm; display: block; margin: 0 auto; padding: 10mm 15mm; 
                    ...
                    <tr><td style="padding-left: 20px; vertical-align: top;">- Sekunder</td>
                        <td>
                            <table class="nested-table">
                                ...
                                <?php if(!empty($data['diagnosa_sekunder4'])): ?><tr><td>4.</td><td><?= $data['kd_diagnosa_sekunder4'] ?> - <?= $data['diagnosa_sekunder4'] ?></td></tr><?php endif; ?>
                            </table>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr><td style="padding-left: 20px; vertical-align: top;">- Sekunder</td>
                        <td>
                            <table class="nested-table">
                                ...
                                <?php if(!empty($data['prosedur_sekunder3'])): ?><tr><td>3.</td><td><?= $data['kd_prosedur_sekunder3'] ?> - <?= $data['prosedur_sekunder3'] ?></td></tr><?php endif; ?>
                            </table>
                        </td>
                    </tr>
                </table>
