<?php
/*
 * File: laporan_rl_4.2.php
 * Fungsi: Laporan RL 4.2 10 Besar Penyakit Rawat Inap
 */
...
<head>
    ...
    <title>Laporan RL 4.2 - 10 Besar Penyakit Ranap</title>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body">
                    <h5 class="fw-bold text-primary mb-3 d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-trophy me-2"></i>Laporan RL 4.2 (10 Besar Penyakit Rawat Inap)</span>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-book-open me-2"></i>Petunjuk Teknis Pengisian RL 4.2</h5>
            ...
            <div class="modal-body" style="font-size: 0.85rem; line-height: 1.5;">
                <div class="alert alert-primary">
                    ...
                    <p>Menampilkan 10 besar penyakit pasien rawat inap yang diurutkan berdasarkan jumlah total pasien keluar (hidup & mati). Kode ICD-10 tertentu (O80, O82, R, V, W, X, Y, Z) biasanya dikecualikan.</p>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-code me-2"></i>Logika Teknis SIMKES Khanza</h6>
                    <p>Mengambil data dari rekapitulasi morbiditas rawat inap (RL 4.1), mengelompokkan berdasarkan 3 digit pertama kode ICD-10, dan mengurutkan 10 diagnosis dengan volume tertinggi.</p>
                    <hr>
