<?php
/*
 * File: api/data_rl_4_3.php
 * Fungsi: API Laporan RL 4.3 10 Besar Kematian Penyakit Rawat Inap (REVISED SQL)
 */
...
// SQL: Aggregate Top 10 Death Causes for Inpatient
...
$sql = "
    ...
    HAVING (mati_l + mati_p) > 0
    ORDER BY (mati_l + mati_p) DESC
    LIMIT 10
";
