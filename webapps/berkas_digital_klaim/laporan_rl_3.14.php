<?php
/*
 * File: laporan_rl_3.14.php
 * Fungsi: Laporan RL 3.14 Rekapitulasi Kegiatan Pelayanan Khusus
 */
...
<head>
    ...
    <title>Laporan RL 3.14 - Pelayanan Khusus</title>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body">
                    <h5 class="fw-bold text-primary mb-3 d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-microscope me-2"></i>Laporan RL 3.14 - Rekapitulasi Kegiatan Pelayanan Khusus</span>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-book-open me-2"></i>Petunjuk Teknis Pengisian RL 3.14</h5>
            ...
            <div class="modal-body" style="font-size: 0.85rem; line-height: 1.5;">
                <div class="alert alert-primary">
                    ...
                    <p>Melaporkan jumlah pelayanan khusus yang diberikan menurut jenis kegiatannya (seperti EKG, EEG, Endoskopi, Hemodialisa, Homecare, dll).</p>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-code me-2"></i>Logika Teknis SIMKES Khanza</h6>
                    <p>Menghitung jumlah tindakan khusus yang tercatat pada rawat jalan yang difilter berdasarkan nama atau kategori tindakan (EKG, EEG, Endoskopi, Hemodialisa, dll).</p>
                    <hr>
