<?php
/*
 * File: laporan_rl_3.11.php
 * Fungsi: Laporan RL 3.11 Rekapitulasi Kegiatan Pelayanan Gigi dan Mulut
 */
...
<head>
    ...
    <title>Laporan RL 3.11 - Gigi dan Mulut</title>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body">
                    <h5 class="fw-bold text-primary mb-3 d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-tooth me-2"></i>Laporan RL 3.11 - Rekapitulasi Kegiatan Pelayanan Gigi dan Mulut</span>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-book-open me-2"></i>Petunjuk Teknis Pengisian RL 3.11</h5>
            ...
            <div class="modal-body" style="font-size: 0.85rem; line-height: 1.5;">
                <div class="alert alert-primary">
                    ...
                    <p>Mencakup data rekapitulasi kegiatan pelayanan Gigi dan Mulut yang meliputi Tumpatan (Tetap/Sulung), Pengobatan Pulpa, Pencabutan, Pengobatan Periodontal, Karang Gigi, Prothese, Orthodonti, Bedah Mulut, Implan, dan Penyakit Mulut. Laporan ini merupakan akumulasi tahunan dari seluruh tindakan yang diberikan di poliklinik gigi.</p>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-code me-2"></i>Logika Teknis SIMKES Khanza</h6>
                    <p>Sistem mengambil data dari tabel <code>rawat_jl_dr</code> atau <code>rawat_jl_pr</code> yang digabungkan dengan <code>jns_perawatan</code>. Tindakan dikelompokkan berdasarkan kata kunci pada nama tindakan (seperti 'Pencabutan', 'Scaling', 'Tambal') atau berdasarkan spesialisasi poli gigi untuk disesuaikan dengan kategori SIRS.</p>
                    <hr>
                    <strong>Sumber Data:</strong>
                    <ul class="mb-0">
                        <li><code>rawat_jl_dr</code> / <code>rawat_jl_pr</code> (Data tindakan jalan)</li>
                        <li><code>jns_perawatan</code> (Master nama dan kategori tindakan)</li>
                        <li><code>poliklinik</code> (Filter unit pelayanan gigi)</li>
                    </ul>
                </div>
            </div>
