<?php
/*
 * File: laporan_rl_3.15.php
 * Fungsi: Laporan RL 3.15 Rekapitulasi Kegiatan Pelayanan Kesehatan Jiwa
 */
...
<head>
    ...
    <title>Laporan RL 3.15 - Kesehatan Jiwa</title>
            ...
            <div class="card shadow-sm mb-4 border-0">
                <div class="card-body">
                    <h5 class="fw-bold text-primary mb-3 d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-brain me-2"></i>Laporan RL 3.15 - Rekapitulasi Kegiatan Pelayanan Kesehatan Jiwa</span>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-book-open me-2"></i>Petunjuk Teknis Pengisian RL 3.15</h5>
            ...
            <div class="modal-body" style="font-size: 0.85rem; line-height: 1.5;">
                <div class="alert alert-primary">
                    ...
                    <p>Melaporkan jumlah kegiatan pelayanan kesehatan jiwa menurut jenis kegiatannya, dipisahkan berdasarkan jenis kelamin (Laki-laki dan Perempuan).</p>
                </div>
                <div class="alert alert-warning">
                    <h6><i class="fas fa-code me-2"></i>Logika Teknis SIMKES Khanza</h6>
                    <p>Menghitung jumlah tindakan yang tercatat pada poliklinik jiwa atau oleh spesialis kedokteran jiwa, difilter berdasarkan nama tindakan seperti Pemeriksaan Psikiatri, Psikoterapi, dll.</p>
                    <hr>
                    <strong>Sumber Data:</strong>
                    <ul class="mb-0">
                        <li>rawat_jl_dr (Tindakan Dokter Ralan)</li>
                        <li>jns_perawatan (Kategori/Nama Tindakan)</li>
                        <li>pasien (Data Jenis Kelamin)</li>
                    </ul>
                </div>
            </div>
    ...
    $(document).ready(function() {
        myTable = $('#dataTable').DataTable({
            columns: [
                ...
                { data: "jenis_kegiatan" },
                { data: "laki", className: "text-end" },
                { data: "perempuan", className: "text-end" },
