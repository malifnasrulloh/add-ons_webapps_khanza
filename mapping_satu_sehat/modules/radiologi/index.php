        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-1">
                        <span id="loinc_source_badge_rad" class="badge bg-secondary" style="font-size:.7rem;"><i class="fa fa-database me-1"></i>Sumber: Database Lokal</span>
                        <a id="loinc_ext_link_rad" href="#" target="_blank" class="badge bg-info text-dark text-decoration-none ms-1" style="font-size:.7rem; display:none;"><i class="fa fa-external-link me-1"></i>Detail di LOINC.org</a>
                    </div>
...
$(function() {
    ...
    $('#sel_loinc_rad').select2({
        ...
        $('#m_loinc_display_rad').val(e.params.data.display); 
        $('#loinc_ext_link_rad').attr('href', 'https://loinc.org/' + e.params.data.id).show();
